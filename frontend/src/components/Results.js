...
function Results({results}) {
            ...
            <div key={index} className="result-section mb-8">
                ...
                <table className="table-auto w-full bg-white rounded-md shadow-md">
                    ...
                    {route.trips.map((trip, tripIndex) => (
                        <tr key={tripIndex}
                            className={`hover:bg-gray-100 ${tripIndex % 2 === 0 ? 'bg-white' : 'bg-gray-100'}`}>
        ...
        return (
            <div className="result-section mb-8">
                ...
                <table className="table-auto w-full bg-white rounded-md shadow-md">
                    <thead>
                    <tr>
                        <th className="px-4 py-2 bg-[#4682B4] text-white">Departure Station</th>
                        <th className="px-4 py-2 bg-[#4682B4] text-white">Departure Time</th>
                        <th className="px-4 py-2 bg-[#4682B4] text-white">Arrival Station</th>
                        <th className="px-4 py-2 bg-[#4682B4] text-white">Arrival Time</th>
                        <th className="px-4 py-2 bg-[#4682B4] text-white">Travel Time</th>
                        <th className="px-4 py-2 bg-[#4682B4] text-white">Train Type</th>
                    </tr>
                    </thead>
                    <tbody>
                    {trains.map((train, index) => (
                        <tr key={index}
                            className={`hover:bg-gray-100 ${train.isActive ? '' : 'bg-gray-200'} ${index % 2 === 0 ? 'bg-white' : 'bg-gray-100'}`}>
    ...
    const renderAPMSResults = (apms) => {
        ...
        return (
            <div className="result-section mb-8">
                <h2 className="text-2xl font-semibold mb-4">Adsadsfs</h2>
                <table className="table-auto w-full bg-white rounded-md shadow-md">
                    <thead>
                    <tr>
                        <th className="px-4 py-2 bg-[#4682B4] text-white">Departure</th>
                        <th className="px-4 py-2 bg-[#4682B4] text-white">Departure Time</th>
                        <th className="px-4 py-2 bg-[#4682B4] text-white">Arrival</th>
                        <th className="px-4 py-2 bg-[#4682B4] text-white">Arrival Time</th>
                        <th className="px-4 py-2 bg-[#4682B4] text-white">Duration</th>
                        <th className="px-4 py-2 bg-[#4682B4] text-white">Kilometers</th>
                    </tr>
                    </thead>
                    <tbody>
                    {apms.map((bus, index) => (
                        <tr key={index} className={`hover:bg-gray-100 ${index % 2 === 0 ? 'bg-white' : 'bg-gray-100'}`}>
            ...
            <div className="result-section mb-8">
                ...
                <table className="table-auto w-full bg-white rounded-md shadow-md">
                    ...
                    <tr>
                        ...
                        <th className="px-4 py-2 bg-[#4682B4] text-white">Arrival</th>
                        <th className="px-4 py-2 bg-[#4682B4] text-white">Arrival Time</th>
                        <th className="px-4 py-2 bg-[#4682B4] text-white">Travel Duration</th>
                        <th className="px-4 py-2 bg-[#4682B4] text-white">Prevoznik</th>
                        <th className="px-4 py-2 bg-[#4682B4] text-white">Length</th>
                        <th className="px-4 py-2 bg-[#4682B4] text-white">Cena</th>
                    </tr>
                    </thead>
                    <tbody>
