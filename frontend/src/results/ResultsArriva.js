...
function ResultsArriva({results}) {
    return (
        <div
            ...
            <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-200">Rezultati za Arriva</h2>
            <div className="overflow-hidden rounded-lg shadow-md border border-gray-300">
                <table
                    ...
                    <tr>
                        ...
                        <th className="px-4 py-2 bg-[#4682B4] dark:bg-purple-900 text-white">Dolžina</th>
                    ...
                    {results.map((bus, index) => (
                        ...
                        >
                            ...
                            <td className="border border-gray-300 dark:border-gray-700 px-4 py-2 text-gray-800 dark:text-gray-200">{bus.travelDuration}</td>
                            <td className="border border-gray-300 dark:border-gray-700 px-4 py-2 text-gray-800 dark:text-gray-200">{bus.length}</td>
                            <td className="border border-gray-300 dark:border-gray-700 px-4 py-2 text-gray-800 dark:text-gray-200">{bus.price}</td>
                        </tr>
                    ))}
                    </tbody>
                </table>
